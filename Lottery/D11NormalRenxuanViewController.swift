//
//  D11NormalRenxuanViewController.swift
//  Lottery
//
...
class D11NormalRenxuanViewController: D11NormalViewController {
    ...
    override func ballNumberChangeAction(_ notification: Notification) {
        ...
        let totalNumber = LotteryUtil.totalNumberD11Renxuan(ballNumber: ballNumber, minBalls: self.minBalls);
    ...
    override func confirmAction() {
        ...
        //selectedBallString
        let selectedBallString = LotteryUtil.toBallStringD11Renxuan(ballArray: self.ballBoardView.ballNumberArray, minBalls: self.minBalls);
    ...
    override func dropDownButtonChangeAction() {
        ...
        LotteryUtil.saveLotterySelectedTypeInt(gameEn: self.gameEn, selectedInt: self.minBalls-2);
    }
